...
https://storage.googleapis.com/kubernetes-release/release/v1.9.10/bin/linux/amd64/kubelet
chmod +x kubelet

# Get kube-apiserver
wget -q --show-progress --https-only --timestamping \
https://storage.googleapis.com/kubernetes-release/release/v1.9.10/bin/linux/amd64/kube-apiserver
...
# Get kube-scheduler
wget -q --show-progress --https-only --timestamping \
https://storage.googleapis.com/kubernetes-release/release/v1.9.10/bin/linux/amd64/kube-scheduler
chmod +x kube-scheduler

# Get kube-controller-manager
wget -q --show-progress --https-only --timestamping \
https://storage.googleapis.com/kubernetes-release/release/v1.9.10/bin/linux/amd64/kube-controller-manager
