...
# Get kubeconfig
wget -q --show-progress --https-only --timestamping \
https://raw.githubusercontent.com/joshuasheppard/k8s-by-component/master/part3/kubeconfig

# Get pod definition
wget -q --show-progress --https-only --timestamping \
https://raw.githubusercontent.com/joshuasheppard/k8s-by-component/master/part3/nginx.yaml

# Get deployment definition
wget -q --show-progress --https-only --timestamping \
https://raw.githubusercontent.com/joshuasheppard/k8s-by-component/master/presentation/nginx-deployment.yaml
